...
| `CLIENT_POOL_MAX`          | `5`         | Max PostgreSQL connections per client pool (HTTP mode only)                                                                                                                    |
| `POOL_IDLE_TIMEOUT_MS`     | `1800000`   | How long (ms) a client pool can sit idle before being swept (default 30 min, HTTP mode only)                                                                                   |
| `POOL_SWEEP_INTERVAL_MS`   | `300000`    | How often (ms) the idle pool sweeper runs (default 5 min, HTTP mode only)                                                                                                      |
